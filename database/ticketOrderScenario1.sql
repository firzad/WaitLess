...
insert into ticket_item(ticket_id, menu_id, remark, item_status, quantity)
	values (1, 1001, 'Extra hot', 'Delivered',1); --create the food item
insert into ticket_item(ticket_id, menu_id, remark, item_status, quantity)
	values (1, 1002, 'Not very hot', 'Delivered',1);
...
insert into ticket_item(ticket_id, menu_id, remark, item_status, quantity)
	values (2, 1001, '', 'Delivered',1); --create the food item
insert into ticket_item(ticket_id, menu_id, remark, item_status, quantity)
	values (2, 1003, 'extra pepper', 'Delivered',1);
insert into ticket_item(ticket_id, menu_id, remark, item_status, quantity)
	values (2, 1004, 'no salt thanks', 'Delivered',1);
